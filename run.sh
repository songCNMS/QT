...
python experiment.py --seed 123 \
    ...
    --max_iters 100 --num_steps_per_iter 10000 --lr_decay \
    --k_rewards --use_discount --reprogram --desc_reg \
...
python experiment.py --seed 123 \
    ...
    --exp_name qt --save_path ./save/    \
    --max_iters 100 --num_steps_per_iter 10000 --lr_decay \
    --early_stop --k_rewards --use_discount --reprogram --desc_reg \
...
python experiment.py --seed 123 \
    --env citylearn --dataset medium-expert   \
    --eta 2.0 --grad_norm 5.0 \
    --exp_name qt --save_path ./save/    \
    --max_iters 100 --num_steps_per_iter 10000 --lr_decay \
    --early_stop --k_rewards --use_discount --reprogram --desc_reg \
